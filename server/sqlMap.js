...
let sqlMap = {
    ...
    nodes: {
        add: 'insert into nodes(taskId, id, name, imgContent, pos_x, pos_y, degree) VALUES (?,?,?,?,?,?,?)',
        list: 'select taskId, id, name, imgContent, pos_x, pos_y, degree from nodes where taskId=?',
